...
\begin{enumerate}
    ...
    of maximum degree $d$. My theory is either width$+1$ or width$\cdot$height. Latter is
...
%\section{Proofs} \subsection{Computing Hanging Trees} \subsection{Solvability}
